...
from askcomrade.apps.users.models import User, Profile
from askcomrade import const
from django.core.cache import cache
from askcomrade.apps.posts.models import Post, Vote
from askcomrade.apps.messagez.models import Message
from askcomrade.apps.planet.models import BlogPost
from django.utils.deprecation import MiddlewareMixin

from collections import defaultdict
from askcomrade.awards import create_user_award, check_user_profile
...
class ExternalAuth(MiddlewareMixin):
    '''
...
def get_cuonts(request, weeks=settings.COUNT_INTERVAL_WEEKS):
